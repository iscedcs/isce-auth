...
async function bootstrap() {
  ...
  app.enableCors({
    origin: ['http://localhost:3000', 'https://eventnest-slbg.onrender.com', 'https://orca-app-mashg.ondigitalocean.app', 'http://localhost:4723', 'https://www.isce.tech'], // Frontend URLs
    methods: ['GET', 'POST'],
